    ...
    var t = foreachiter0_target[foreachiter0];
    {
      if (t.fromState == "*" || t.fromState == event.oldValue) {
        if (t.toState == "*" || t.toState == event.newValue) {
          this.org_apache_royale_core_StatesWithTransitionsImpl_transitionEffects = t.effects.slice();
          var foreachiter1_target = this.org_apache_royale_core_StatesWithTransitionsImpl_transitionEffects;
 ...
 * @type {number}
 */
org.apache.royale.core.StatesWithTransitionsImpl.prototype.ROYALE_REFLECTION_INFO.compileFlags = 10;
