...
mx.core.IFlexModuleFactory.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'getImplementation': { type: 'Object', declaredBy: 'mx.core.IFlexModuleFactory', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
 ...
 * @type {number}
 */
mx.core.IFlexModuleFactory.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
