...
/* Royale Dependency List: mx.controls.beads.ToolTipBead,mx.core.FlexCSSStyles,mx.core.FlexGlobals,mx.core.IFlexModuleFactory,mx.core.LayoutElementUIComponentUtils,mx.core.UITextFormat,mx.core.mx_internal,mx.display.Graphics,mx.events.FlexEvent,mx.events.KeyboardEvent,mx.events.PropertyChangeEvent,mx.events.ValidationResultEvent,mx.managers.ICursorManager,mx.managers.IFocusManager,mx.managers.IFocusManagerContainer,mx.managers.ISystemManager,mx.resources.IResourceManager,mx.resources.ResourceManager,mx.styles.IStyleManager2,mx.styles.StyleManager,mx.validators.ValidationResult,org.apache.royale.core.CallLaterBead,org.apache.royale.core.IChild,org.apache.royale.core.IStatesImpl,org.apache.royale.core.IUIBase,org.apache.royale.core.TextLineMetrics,org.apache.royale.core.ValuesManager,org.apache.royale.effects.IEffect,org.apache.royale.events.Event,org.apache.royale.events.IEventDispatcher,org.apache.royale.events.MouseEvent,org.apache.royale.events.ValueChangeEvent,org.apache.royale.geom.Point,org.apache.royale.geom.Rectangle,org.apache.royale.html.beads.DisableBead,org.apache.royale.html.beads.DisabledAlphaBead,org.apache.royale.html.supportClasses.ContainerContentArea,org.apache.royale.utils.PointUtils,org.apache.royale.utils.loadBeadFromValuesManager,org.apache.royale.utils.Language,XML*/
 ...
 * @type {string}
 */
mx.core.UIComponent.prototype._errorString = "";
 ...
 * @type {boolean}
 */
mx.core.UIComponent.prototype.saveBorderColor = true;
 ...
 * @type {number}
 */
mx.core.UIComponent.prototype.origBorderColor;
  ...
  if (showErrorSkin) {
    if (!this._errorString || this._errorString.length == 0) {
      ...
      if (this.saveBorderColor) {
        ...
        this.origBorderColor = Number(this.getStyle("borderColor"));
      }
...
mx.core.UIComponent.prototype.contains = function(child) {
  org.apache.royale.utils.Language.trace("contains not implemented");
  return true;
};
 ...
 * @type {number}
 */
mx.core.UIComponent.prototype.mx_core_UIComponent_contentMouseX;
 ...
 * @type {number}
 */
mx.core.UIComponent.prototype.mx_core_UIComponent_contentMouseY;
...
mx.core.UIComponent.prototype.get__accessibilityEnabled = function() {
  org.apache.royale.utils.Language.trace("accessibilityEnabled not implemented");
  return false;
};
...
mx.core.UIComponent.prototype.set__errorString = function(value) {
  if (value == this._errorString)
    return;
  this.mx_core_UIComponent_oldErrorString = this._errorString;
...
mx.core.UIComponent.prototype.set__toolTip = function(value) {
  ...
  if (this.mx_core_UIComponent__toolTip != null && this.mx_core_UIComponent__toolTip != "" && this.mx_core_UIComponent__toolTipBead == null) {
    ...
    this.removeBead(this.mx_core_UIComponent__toolTipBead);
...
mx.core.UIComponent.prototype.get__uid = function() {
  org.apache.royale.utils.Language.trace("uid not implemented");
  return 0;
};


mx.core.UIComponent.prototype.set__uid = function(value) {
  org.apache.royale.utils.Language.trace("uid not implemented");
};
  ...
  return {
    ...
    accessors: function () {
      return {
        ...
        'uid': { type: 'Object', access: 'readwrite', declaredBy: 'mx.core.UIComponent'},
    ...
    methods: function () {
      return {
        ...
        'addChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        '$uibase_addChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'addChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        '$uibase_addChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        'removeChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        '$uibase_removeChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'swapChildren': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'removeChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        '$uibase_removeChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        'getChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        'setChildIndex': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        'getChildIndex': { type: 'int', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'getChildByName': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'contains': { type: 'Boolean', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'startDrag': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true },{ index: 2, type: 'org.apache.royale.geom.Rectangle', optional: true } ]; }},
        ...
        'localToGlobal': { type: 'org.apache.royale.geom.Point', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'org.apache.royale.geom.Point', optional: false } ]; }},
        'globalToLocal': { type: 'org.apache.royale.geom.Point', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'org.apache.royale.geom.Point', optional: false } ]; }},
        'getFocus': { type: 'mx.core.UIComponent', declaredBy: 'mx.core.UIComponent'},
        'styleChanged': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'validateNow': { type: 'void', declaredBy: 'mx.core.UIComponent'},
        'callLater': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Function', optional: false },{ index: 2, type: 'Array', optional: true } ]; }},
        'validateProperties': { type: 'void', declaredBy: 'mx.core.UIComponent'},
        'validateSize': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        ...
        'measureText': { type: 'org.apache.royale.core.TextLineMetrics', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'validateDisplayList': { type: 'void', declaredBy: 'mx.core.UIComponent'},
        'move': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false } ]; }},
        'setActualSize': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false } ]; }},
        'setFocus': { type: 'void', declaredBy: 'mx.core.UIComponent'},
        'clearStyle': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'getStyle': { type: '*', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }, metadata: function () { return [ { name: 'Bindable', args: [ { key: 'style', value: 'true' } ] } ]; }},
        'setStyle': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: '*', optional: false } ]; }},
        'owns': { type: 'Boolean', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'setVisible': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: false } ]; }},
        'getPreferredBoundsWidth': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getPreferredBoundsHeight': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getMinBoundsWidth': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getMinBoundsHeight': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getMaxBoundsWidth': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getMaxBoundsHeight': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getBoundsXAtSize': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false },{ index: 3, type: 'Boolean', optional: true } ]; }},
        'getBoundsYAtSize': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false },{ index: 3, type: 'Boolean', optional: true } ]; }},
        'getLayoutBoundsWidth': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getLayoutBoundsHeight': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getLayoutBoundsX': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'getLayoutBoundsY': { type: 'Number', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Boolean', optional: true } ]; }},
        'setLayoutBoundsPosition': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false },{ index: 3, type: 'Boolean', optional: true } ]; }},
        'setLayoutBoundsSize': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false },{ index: 3, type: 'Boolean', optional: true } ]; }},
        'stylesInitialized': { type: 'void', declaredBy: 'mx.core.UIComponent'},
        'validationResultHandler': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'mx.events.ValidationResultEvent', optional: false } ]; }},
        'addElement': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'org.apache.royale.core.IChild', optional: false },{ index: 2, type: 'Boolean', optional: true } ]; }},
        'addElementAt': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'org.apache.royale.core.IChild', optional: false },{ index: 2, type: 'int', optional: false },{ index: 3, type: 'Boolean', optional: true } ]; }},
        'removeElement': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'org.apache.royale.core.IChild', optional: false },{ index: 2, type: 'Boolean', optional: true } ]; }},
        'addEventListener': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'Function', optional: false },{ index: 3, type: 'Boolean', optional: true },{ index: 4, type: 'Object', optional: true } ]; }},
        'removeEventListener': { type: 'void', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'Function', optional: false },{ index: 3, type: 'Boolean', optional: true },{ index: 4, type: 'Object', optional: true } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.UIComponent.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
...
mx.core.UIComponent.EffectEventWatcher.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'EffectEventWatcher': { type: '', declaredBy: 'mx.core.UIComponent.EffectEventWatcher', parameters: function () { return [ { index: 1, type: 'org.apache.royale.effects.IEffect', optional: false } ]; }},
        'listener': { type: 'void', declaredBy: 'mx.core.UIComponent.EffectEventWatcher', parameters: function () { return [ { index: 1, type: 'org.apache.royale.events.Event', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.UIComponent.EffectEventWatcher.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
...
mx.core.UIComponent.MethodQueueElement.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'MethodQueueElement': { type: '', declaredBy: 'mx.core.UIComponent.MethodQueueElement', parameters: function () { return [ { index: 1, type: 'Function', optional: false },{ index: 2, type: 'Array', optional: true } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.UIComponent.MethodQueueElement.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
