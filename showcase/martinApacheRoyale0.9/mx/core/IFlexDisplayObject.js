...
mx.core.IFlexDisplayObject.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'globalToLocal': { type: 'org.apache.royale.geom.Point', declaredBy: 'mx.core.IFlexDisplayObject', parameters: function () { return [ { index: 1, type: 'org.apache.royale.geom.Point', optional: false } ]; }},
        'localToGlobal': { type: 'org.apache.royale.geom.Point', declaredBy: 'mx.core.IFlexDisplayObject', parameters: function () { return [ { index: 1, type: 'org.apache.royale.geom.Point', optional: false } ]; }},
        'move': { type: 'void', declaredBy: 'mx.core.IFlexDisplayObject', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false } ]; }},
        'setActualSize': { type: 'void', declaredBy: 'mx.core.IFlexDisplayObject', parameters: function () { return [ { index: 1, type: 'Number', optional: false },{ index: 2, type: 'Number', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.IFlexDisplayObject.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
