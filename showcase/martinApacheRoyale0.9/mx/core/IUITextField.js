...
mx.core.IUITextField.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'getStyle': { type: '*', declaredBy: 'mx.core.IUITextField', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'getUITextFormat': { type: 'mx.core.UITextFormat', declaredBy: 'mx.core.IUITextField'},
        'setColor': { type: 'void', declaredBy: 'mx.core.IUITextField', parameters: function () { return [ { index: 1, type: 'uint', optional: false } ]; }},
        'setFocus': { type: 'void', declaredBy: 'mx.core.IUITextField'},
        'truncateToFit': { type: 'Boolean', declaredBy: 'mx.core.IUITextField', parameters: function () { return [ { index: 1, type: 'String', optional: true } ]; }},
        'setTextFormat': { type: 'void', declaredBy: 'mx.core.IUITextField', parameters: function () { return [ { index: 1, type: 'mx.core.UITextFormat', optional: false },{ index: 2, type: 'int', optional: true },{ index: 3, type: 'int', optional: true } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.IUITextField.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
