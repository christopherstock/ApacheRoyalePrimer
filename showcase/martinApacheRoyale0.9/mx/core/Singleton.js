...
mx.core.Singleton.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        '|registerClass': { type: 'void', declaredBy: 'mx.core.Singleton', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'Class', optional: false } ]; }},
        '|getClass': { type: 'Class', declaredBy: 'mx.core.Singleton', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        '|getInstance': { type: 'Object', declaredBy: 'mx.core.Singleton', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.Singleton.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
