...
mx.core.IChildList.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'addChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'addChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        'removeChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'removeChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        'getChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        'getChildByName': { type: 'mx.core.IUIComponent', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'getChildIndex': { type: 'int', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'setChildIndex': { type: 'void', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        'contains': { type: 'Boolean', declaredBy: 'mx.core.IChildList', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.core.IChildList.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
