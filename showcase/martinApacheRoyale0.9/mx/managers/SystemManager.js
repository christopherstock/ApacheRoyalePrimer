  ...
  return {
    ...
    methods: function () {
      return {
        ...
        'addChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'addChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        'removeChild': { type: 'mx.core.IUIComponent', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'removeChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        'getChildAt': { type: 'mx.core.IUIComponent', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'int', optional: false } ]; }},
        'create': { type: 'Object', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'Array', optional: false } ]; }},
        'info': { type: 'Object', declaredBy: 'mx.managers.SystemManager'},
        'start': { type: 'void', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'Object', optional: true } ]; }},
        'getSandboxRoot': { type: 'Object', declaredBy: 'mx.managers.SystemManager'},
        'getImplementation': { type: 'Object', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'setChildIndex': { type: 'void', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        'getChildIndex': { type: 'int', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }},
        'getChildByName': { type: 'mx.core.IUIComponent', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'contains': { type: 'Boolean', declaredBy: 'mx.managers.SystemManager', parameters: function () { return [ { index: 1, type: 'mx.core.IUIComponent', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.managers.SystemManager.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
