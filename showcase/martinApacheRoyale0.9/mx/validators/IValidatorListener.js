...
mx.validators.IValidatorListener.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'validationResultHandler': { type: 'void', declaredBy: 'mx.validators.IValidatorListener', parameters: function () { return [ { index: 1, type: 'mx.events.ValidationResultEvent', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.validators.IValidatorListener.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
