...
mx.resources.LocaleSorter.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        '|sortLocalesByPreference': { type: 'Array', declaredBy: 'mx.resources.LocaleSorter', parameters: function () { return [ { index: 1, type: 'Array', optional: false },{ index: 2, type: 'Array', optional: false },{ index: 3, type: 'String', optional: true },{ index: 4, type: 'Boolean', optional: true } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.resources.LocaleSorter.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
...
mx.resources.LocaleSorter.LocaleID.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        '|fromString': { type: 'mx.resources.LocaleSorter.LocaleID', declaredBy: 'mx.resources.LocaleSorter.LocaleID', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        ...
        'equals': { type: 'Boolean', declaredBy: 'mx.resources.LocaleSorter.LocaleID', parameters: function () { return [ { index: 1, type: 'LocaleID', optional: false } ]; }},
        'isSiblingOf': { type: 'Boolean', declaredBy: 'mx.resources.LocaleSorter.LocaleID', parameters: function () { return [ { index: 1, type: 'LocaleID', optional: false } ]; }},
 ...
 * @type {number}
 */
mx.resources.LocaleSorter.LocaleID.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
...
mx.resources.LocaleSorter.LocaleRegistry.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        '|getScriptByLangAndRegion': { type: 'String', declaredBy: 'mx.resources.LocaleSorter.LocaleRegistry', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'String', optional: false } ]; }},
        '|getScriptByLang': { type: 'String', declaredBy: 'mx.resources.LocaleSorter.LocaleRegistry', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        '|getDefaultRegionForLangAndScript': { type: 'String', declaredBy: 'mx.resources.LocaleSorter.LocaleRegistry', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'String', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.resources.LocaleSorter.LocaleRegistry.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
