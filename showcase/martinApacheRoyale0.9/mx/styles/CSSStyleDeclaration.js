...
mx.styles.CSSStyleDeclaration.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'CSSStyleDeclaration': { type: '', declaredBy: 'mx.styles.CSSStyleDeclaration', parameters: function () { return [ { index: 1, type: 'Object', optional: true },{ index: 2, type: 'mx.styles.IStyleManager2', optional: true },{ index: 3, type: 'Boolean', optional: true } ]; }},
        'getStyle': { type: '*', declaredBy: 'mx.styles.CSSStyleDeclaration', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'setStyle': { type: 'void', declaredBy: 'mx.styles.CSSStyleDeclaration', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: '*', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.styles.CSSStyleDeclaration.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
