...
mx.styles.StyleManager.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        '|getStyleManager': { type: 'mx.styles.IStyleManager2', declaredBy: 'mx.styles.StyleManager', parameters: function () { return [ { index: 1, type: 'mx.core.IFlexModuleFactory', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.styles.StyleManager.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
