...
mx.styles.IStyleManager.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'getStyleDeclaration': { type: 'mx.styles.CSSStyleDeclaration', declaredBy: 'mx.styles.IStyleManager', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        'setStyleDeclaration': { type: 'void', declaredBy: 'mx.styles.IStyleManager', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'mx.styles.CSSStyleDeclaration', optional: false },{ index: 3, type: 'Boolean', optional: false } ]; }},
        'isValidStyleValue': { type: 'Boolean', declaredBy: 'mx.styles.IStyleManager', parameters: function () { return [ { index: 1, type: '*', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.styles.IStyleManager.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
