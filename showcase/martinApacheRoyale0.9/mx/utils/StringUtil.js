...
mx.utils.StringUtil.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        '|trim': { type: 'String', declaredBy: 'mx.utils.StringUtil', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        '|trimArrayElements': { type: 'String', declaredBy: 'mx.utils.StringUtil', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'String', optional: false } ]; }},
        '|isWhitespace': { type: 'Boolean', declaredBy: 'mx.utils.StringUtil', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }},
        '|substitute': { type: 'String', declaredBy: 'mx.utils.StringUtil', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'Array', optional: false } ]; }},
        '|repeat': { type: 'String', declaredBy: 'mx.utils.StringUtil', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'int', optional: false } ]; }},
        '|restrict': { type: 'String', declaredBy: 'mx.utils.StringUtil', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: 'String', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.utils.StringUtil.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
