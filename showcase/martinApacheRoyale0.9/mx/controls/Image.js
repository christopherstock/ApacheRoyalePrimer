  ...
  return {
    ...
    methods: function () {
      return {
        ...
        'applyImageData': { type: 'void', declaredBy: 'mx.controls.Image', parameters: function () { return [ { index: 1, type: 'String', optional: false } ]; }}
      };
    }
  };
};
 ...
 * @type {number}
 */
mx.controls.Image.prototype.ROYALE_REFLECTION_INFO.compileFlags = 26;
